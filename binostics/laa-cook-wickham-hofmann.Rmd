...
There are eight measures calculated in scagnostics: outlying, skewed, sparse, clumpy, striated, convex, skinny, stringy, and monotonic. In our example the plots differ clearly in values of outlying (large for 3, 4), monotonic (large for 3), clumpy (larger for 4) and measures sensitive to the level of noise (striated and stringy are large for all plots except 1).
